...
const client = {
  client_name: 'Super Snow Lodge Verifier',
  logo_uri: 'https://shdsydaadvcstg.blob.core.windows.net/aad-vc-logos/Logo-SymbolAndText-MidnightOnTransparent-Small.png',
  tos_uri: 'https://www.microsoft.com/servicesagreement',
  client_purpose: 'Validate access to the Snow Lodge Resources.'
}
...
const credential = 'https://beta.did.msidentity.com/v1.0/4d1f1af1-b858-4c75-b70a-1656ac585141/verifiableCredential/contracts/ArincoAADTest';
const credentialType = 'ArincoTestVC';
const issuerDid = ['did:ion:EiDqqAHJBihbcWGmnFWfx56SxOine_322th94mp8SjKslw:'];
...
// const privateKey = fs.readFileSync('/etc/letsencrypt/live/supersnowlodge.vc.demo.arinco.com.au/privkey.pem', 'utf8');
// const certificate = fs.readFileSync('/etc/letsencrypt/live/supersnowlodge.vc.demo.arinco.com.au/cert.pem', 'utf8');
// const ca = fs.readFileSync('/etc/letsencrypt/live/supersnowlodge.vc.demo.arinco.com.au/chain.pem', 'utf8');
...
app.get('/presentation-response', async (req, res) => {
  ...
  if (req.session.verifiedCredential) {
    ...
    return res.send(`<p>Welcome, ${presentedCredential.vc.credentialSubject.firstName} ${presentedCredential.vc.credentialSubject.lastName} to the Super Snow Club!</p>`)  
  }
