...
!(function () {
    ...
    var w = (function () {
        ...
        D =
            "svg" === document.documentElement.tagName.toLowerCase()
                ...
                : (function () {
                      function t() {
                          (this._elImage.src = this._elCanvas.toDataURL("image/png")), (this._elImage.style.display = "auto"), (this._elCanvas.style.display = "auto");
                      }
    ...
    ((QRCode = function (t, e) {
        if (((this._htOption = { width: 256, height: 256, typeNumber: 4, colorDark: "#000000", colorLight: "#ffffff", correctLevel: o.H }), "string" == typeof e && (e = { text: e }), e)) for (var r in e) this._htOption[r] = e[r];
