...
const credential = 'https://beta.did.msidentity.com/v1.0/500a042f-c383-4962-b502-e378fb33b2bf/verifiableCredential/contracts/EmployeeVC';
const credentialType = ['EmployeeVC'];
...
// const privateKey = fs.readFileSync('/etc/letsencrypt/live/issuer.vc.demo.arinco.com.au/privkey.pem', 'utf8');
// const certificate = fs.readFileSync('/etc/letsencrypt/live/issuer.vc.demo.arinco.com.au/cert.pem', 'utf8');
// const ca = fs.readFileSync('/etc/letsencrypt/live/issuer.vc.demo.arinco.com.au/chain.pem', 'utf8');
